    ...
    <div className="flex min-h-dvh flex-col bg-canvas">
      ...
      <main id="main" className="flex-1">
        <section className="mx-auto max-w-5xl px-5 py-16 sm:py-24">
          <p className="text-sm font-medium text-accent-text">Independent college application planner</p>
        ...
        <section id="how-it-works" className="border-y border-line bg-surface">
          <div className="mx-auto max-w-5xl px-5 py-14">
            <h2 className="text-xl font-semibold text-ink sm:text-2xl">What you can do</h2>
            <div className="mt-8 grid gap-x-10 gap-y-8 sm:grid-cols-2">
              {features.map((feature) => (
                <div key={feature.title} className="flex gap-3.5">
                  <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-[var(--radius)] bg-accent-soft text-accent-text">
        ...
        <section className="mx-auto max-w-5xl px-5 py-14">
          <h2 className="text-xl font-semibold text-ink sm:text-2xl">How we handle your writing</h2>
        ...
        <section className="border-t border-line bg-surface">
          <div className="mx-auto max-w-3xl px-5 py-14">
            <h2 className="text-xl font-semibold text-ink">What ApplyPilot will not do</h2>
            <ul className="mt-5 flex flex-col gap-3 text-sm text-ink-muted">
              <li>
                <strong className="font-medium text-ink">It will not submit anything for you.</strong>{' '}
                ApplyPilot is a planning tool. You submit your applications yourself, on the official
                sites, with your own account.
              </li>
              <li>
                <strong className="font-medium text-ink">It will not predict your chances.</strong>{' '}
                There is no acceptance calculator here, because no honest one exists.
              </li>
              <li>
                <strong className="font-medium text-ink">It will not write your essay as you.</strong>{' '}
      ...
      <footer className="border-t border-line bg-surface">
        <div className="mx-auto flex max-w-5xl flex-col gap-4 px-5 py-8">
          ...
          <p className="text-xs text-ink-subtle">
            ApplyPilot does not provide legal, financial or professional admissions advice. Deadlines,
            requirements, costs and policies change — always confirm them on the college&rsquo;s
            official website.
          </p>
        </div>
      </footer>
...
function PrivacyPoint({
  ...
  return (
    <div>
      <span className="flex size-8 items-center justify-center rounded-[var(--radius)] bg-surface-muted text-ink-muted">
